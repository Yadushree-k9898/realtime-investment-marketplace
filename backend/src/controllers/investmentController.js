...
//         session.endSession();
//     }
//     // inside investInProposal
// console.log("Investment attempt:", { proposalId, amount, message, userId });
...
//     try {
//       const { amount, industry, investmentType, investmentStage, message } = req.body;
//       const proposalId = req.params.id;
...
//       const returns = amount * 1.2; // 20% basic returns
//       const roi = ((returns - amount) / amount) * 100;
//       const equityOwnership = (amount / proposal.fundingGoal) * 100;
//       const expectedReturn = amount * 1.5; // 50% target return
...
//       // Update proposal funding and investor list
//       proposal.currentFunding = (proposal.currentFunding || 0) + amount;
//       proposal.returns = (proposal.returns || 0) + returns;
...
exports.investInProposal = async (req, res) => {
    ...
    try {
      ...
      // Update proposal funding and investor list
      proposal.currentFunding = (Number(proposal.currentFunding) || 0) + amount;
      proposal.returns = (Number(proposal.returns) || 0) + returns;
      ...
      // Log before saving to check currentFunding value
      console.log("Updated Proposal Funding:", proposal.currentFunding);
